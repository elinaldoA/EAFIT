...
- **Demonstração de execução** — botão "▶ Ver execução" na lista de exercícios e no modo ao vivo, alternando dois quadros do movimento. Cobre 200 nomes de exercício; os sem equivalente seguro não mostram o botão. Imagens do [Free Exercise DB](https://github.com/yuhonas/free-exercise-db) (domínio público), em `app-react/public/exercicios/`, fora do precache e guardadas em cache após a primeira visualização. Mapeamento em `app-react/src/data/exerciseMedia.js`.
